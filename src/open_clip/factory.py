...
from .lcl_model import LCL
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, LCLLoss
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if custom_text:
            ...
            elif "lcl" in model_name.lower():
                model = LCL(**model_cfg, cast_dtype=cast_dtype)
            else:
...
def create_loss(args):
    ...
    elif "lcl" in args.model.lower():
        return LCLLoss(
            generation_loss_weight=args.lcl_generation_loss_weight,
            contrastive_loss_weight=args.lcl_contrastive_loss_weight,
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
