...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Whether use interleaved wrapper for tokenizer."
    )
    parser.add_argument(
        "--interleaved-context-length",
        type=int,
        default=None,
        help="Length of interleaved sequence.",
    )
    parser.add_argument(
        "--num-img-token",
        type=int,
        default=None,
        help="Number of tokens per image to plugin interleaved sequence.",
    )
    parser.add_argument(
        "--img-first-prob",
        type=float,
    ...
    # For LCL loss
    parser.add_argument(
        "--lcl-generation-loss-weight",
        type=float,
        default=1.0,
        help="Weight assigned to generation loss in LCL."
    )
    parser.add_argument(
        "--lcl-contrastive-loss-weight",
        type=float,
        default=0.1,
        help="Weight assigned to contrastive loss when training LCL."
    )
